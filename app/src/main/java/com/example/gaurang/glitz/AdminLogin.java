   ...
   /* @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b_forget_pass.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(AdminLogin.this, AdminResetPassword.class));
                finish();
            }
        });
        b_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                auth.signInWithEmailAndPassword(mail_id, pass).addOnCompleteListener(AdminLogin.this, new OnCompleteListener<AuthResult>() {
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            if (user.isEmailVerified()) {
                                Intent intent = new Intent(AdminLogin.this, User_msg.class);
                                startActivity(intent);
                                finish();
                            }else{
                                Toast.makeText(AdminLogin.this, "Verify the email to continue", Toast.LENGTH_LONG).show();
                            }
                        }
                    }
                });
