    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b_sign_in.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(EmpSignUp.this, EmpLogin.class));
                finish();
            }
        });
        ...
        b_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                auth.createUserWithEmailAndPassword(mail_id, passwd).addOnCompleteListener(EmpSignUp.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            Toast.makeText(EmpSignUp.this, "Authentication failed." + task.getException(),
                                    Toast.LENGTH_LONG).show();
                        } else {
                            startActivity(new Intent(EmpSignUp.this, EmpEmailVerify.class));
                            finish();
                        }
                    }
