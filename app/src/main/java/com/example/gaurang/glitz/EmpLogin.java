   ...
   /* @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (auth.getCurrentUser() != null) {
            this.startActivity(new Intent(this, User_msg.class));
            finish();
        }
        ...
        b_sign_up.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(EmpLogin.this, EmpSignUp.class));
                finish();
            }
        });
        b_forget_pass.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(EmpLogin.this, EmpResetPassword.class));
                finish();
            }
        });
        b_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                auth.signInWithEmailAndPassword(mail_id, pass).addOnCompleteListener(EmpLogin.this, new OnCompleteListener<AuthResult>() {
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            Toast.makeText(EmpLogin.this, "Login Failed", Toast.LENGTH_LONG).show();
                        } else {
                            user=FirebaseAuth.getInstance().getCurrentUser();
                            if (user.isEmailVerified()) {
                                Intent intent = new Intent(EmpLogin.this, User_msg.class);
                                startActivity(intent);
                                finish();
                            }else{
                                Toast.makeText(EmpLogin.this, "Verify the email to continue", Toast.LENGTH_LONG).show();
                            }
                        }
                    }
                });
